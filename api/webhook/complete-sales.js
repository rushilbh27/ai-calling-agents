// Vercel Serverless Function to receive sales completion webhook at /api/webhook/complete-sales (Redis)
...
module.exports = async (req, res) => {
  ...
  if (body.message === 'Calling complete') {
    try {
      const r = getRedis();
      await r.set('sales_calls_complete', JSON.stringify({ done: true, at: Date.now() }));
